...
INSERT INTO MS_USUARIOS.USUARIO (user, clave, id_tipo_usuario) VALUES
    ('usuario1', 'clave1', 1),
    ('usuario2', 'clave2', 1),
    ('usuario3', 'clave3', 2),
    ('usuario4', 'clave4', 2);
...
INSERT INTO MS_USUARIOS.CLIENTE (razon_social, cuit, mail, max_cuenta_corriente, id_usuario) VALUES
    ('customer1', '1111', 'customer1@example.com', 1000.0, 1),
    ('customer2', '2222', 'customer2@example.com', 2000.0, 2);
